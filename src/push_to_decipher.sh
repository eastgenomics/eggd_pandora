...
python3 /home/dnanexus/push_to_decipher.py --configuration api_keys.json --data_for_decipher case_phenotype_and_variant_data.json --submitter $decipher_submitter_id
