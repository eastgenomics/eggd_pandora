...
then
    ...
    mkdir -p /home/dnanexus/out/clinvar_json

    mv *_clinvar_data.json /home/dnanexus/out/clinvar_json

    for json in $(ls /home/dnanexus/out/clinvar_json)
    do
        python3 /home/dnanexus/push_to_clinvar.py \
        --clinvar_api_key /home/dnanexus/in/clinvar_api_key/*.txt \
        --clinvar_json /home/dnanexus/out/clinvar_json/$json \
        --clinvar_testing $clinvar_testing
    done
    mkdir /home/dnanexus/out/submission_id
